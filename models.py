...
# --------------------------
# Logistic Regression
LR_paramGrid = {'penalty': ['l1', 'l2'], 'C': [0.1, 0.5, 1, 5, 10]}
...
# --------------------------
# Random Forests
RF_paramGrid = {'n_estimators': [10, 50, 100, 200, 500], 'max_depth': [None, 2, 4, 8, 16], 'min_samples_split': [2, 4, 8, 16], 'ccp_alpha': [0, 0.01, 0.02, 0.03, 0.05, 0.1]}
